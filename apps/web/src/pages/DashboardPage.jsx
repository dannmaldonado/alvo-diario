...
import { useScheduleCalculator } from '@/hooks/useScheduleCalculator.js';
    ...
    try {
      ...
      if (monthSessions.length > 0) {
        ...
        monthSessions.forEach(s => {
          totalMins += s.duracao_minutos;
          subjectCounts[s.materia] = (subjectCounts[s.materia] || 0) + s.duracao_minutos;
        });
