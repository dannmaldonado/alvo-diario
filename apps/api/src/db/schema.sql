...
-- AI question system tables — TEMPORARILY DISABLED for debugging 503 issue
-- Will re-enable once root cause is found
-- These tables will be created once app is stable
